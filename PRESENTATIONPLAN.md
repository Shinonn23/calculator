...
## ส่วนที่ 6 — Error Messages [~0:45 นาที]

> "cmath-solver ออกแบบ error message ให้อ่านเข้าใจง่าย — บอกว่าเกิดอะไรขึ้น ที่ไหน และควรทำอะไรต่อ"

**ตัวแปรที่ยังไม่ได้กำหนด:**
```
z + 1
```
> "ใช้ตัวแปรที่ยังไม่มีใน context — โปรแกรมบอกชื่อตัวแปรที่หาไม่เจอ พร้อม suggestion"
...
a
```
> "ตั้ง a ขึ้นกับ b และ b ขึ้นกับ a — โปรแกรมตรวจจับ circular dependency และแจ้งเส้นทางที่วนซ้ำ"

**สมการไม่มีคำตอบจริง:**
```
:solve x^2 + 4 = 0
```
> "สมการกำลังสองที่ discriminant < 0 — แจ้งว่าไม่มีคำตอบจริง ไม่ใช่แค่ crash หรือ output ว่างเปล่า"

**ระบบสมการไม่สอดคล้อง:**
```
:solve x + y = 5; x + y = 3
```
> "ระบบสมการที่ขัดแย้งกัน — โปรแกรมแจ้ง no solution พร้อม error code ที่ระบุชัดเจน"

**ระบบสมการมีคำตอบอนันต์:**
```
:solve x + y = 5; 2*x + 2*y = 10
```
> "สมการซ้ำซ้อนกัน — แจ้ง infinite solutions พร้อมบอก free variables ที่เหลือ"

**Input ที่ไม่ถูก syntax:**
```
:solve = x 5
```
> "parser error — ชี้ตำแหน่งที่ผิดใน input บอก expected token และ help text แนะนำ syntax ที่ถูก"

---

## ส่วนที่ 7 — Advanced Features [~1:00 นาที]
